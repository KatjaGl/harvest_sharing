...
user1 = User.create!(nickname: "Maus", last_name: "lolo", first_name: "david", address: "32 avenue du général de gaulle 06000 Nice", email: "jjj@live.fr", password: "azerty")
p "user create"
user2 = User.create!(nickname: "Maus2", last_name: "Cama", first_name: "Maria", address: "22 rue de la fête 75001 Paris", email: "mariac@gmail.com", password: "azerty")
user3 = User.create!(nickname: "Superman", last_name: "Labella", first_name: "Manue", address: "33 avenue de la joie 13000 Marseille", email: "3jj@live.fr", password: "azerty0")
p "user create"
...
user5 = User.create!(nickname: "Lune", last_name: "lacodeuse", first_name: "Katia", address: "25 rue de la fête 13000 Marseille", email: "jkj@live.fr", password: "azerty3")
...
garden1 = Garden.create!(name: " Le Jardins des Belles Fleurs", address: "5 rue maier 06000 Nice", user_id: user1.id)
p "garden create"
garden2 = Garden.create!(name: "Le jardin des amoureux", address: "Rue des biens-heureux, 06000 Nice", user_id: user2.id)
p "garden create"
garden3 = Garden.create!(name: "Le jardin Des Lilas", address: "3 avenue malaussena 06000 Nice", user_id: user3.id)
p "garden create"
garden4 = Garden.create!(name: "Le Jardin Les Orangers", address: "Rue des bisous, 06000 Nice", user_id: user8.id)
p "garden create"
garden5 = Garden.create!(name: "Le jardin Fleur de Jade", address: "25 rue de la joie 06000 Nice", user_id: user4.id)
p "garden create"
garden6 = Garden.create!(name: "Le jardin de Marie", address: "3 rue Berlioz, 06000 Nice", user_id: user5.id)
p "garden create"
garden7 = Garden.create!(name: "Le jardin de Gustave", address: "5 rue d'Arsène, 06000 nice", user_id: user6.id)
p "garden create"
garden8 = Garden.create!(name: "Le jardin des fraisiers", address: "3 boulevard dubouchage, 06000 Nice", user_id: user7.id)
p "garden create"

...
gardenProduct9 = GardenProduct.create!(product_id: product1.id, garden_id: garden9.id, quantity: "10")
...
gardenProduct11 = GardenProduct.create!(product_id: product1.id, garden_id: garden11.id, quantity: "35")
